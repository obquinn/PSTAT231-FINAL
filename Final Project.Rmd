...
To predict `com_1` with `gender`, `party.y`, `age`, `black`, `hispanic`, `recipient_cfscore`, `total_receipts`, `num_givers`, `total_pc_contribs`, `party_coord_exp`, `total_pac_contribs`, `district_partisanship`, `region`, `prcnt_foreign_born`, `prcnt_white`, `median_income`, `prcnt_ba`, and `gini` (dummy the factors + center and scale all predictors):
